...
function ToggleTheme({ styles }) {
  ...
  return (
    <div
      ...
      className={`shadow-sm relative mt-1 bg-blue-sky-3 dark:bg-gray-25 rounded-full cursor-pointer flex flex-row justify-center items-center w-10 h-5 laptop:w-14 laptop:h-7 ${styles}`}
    >
      <div
